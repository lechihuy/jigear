<div class="bg-gray-100 pt-28">
    <x-container>
        ...
        <div class="flex gap-4">
            <div class="bg-white h-full rounded-2xl drop-shadow-lg">
                ...
                <div class="flex py-4 justify-around items-center">
                    <p class="font-light text-slate-500">Giá: 200$</p>
                    <button class="rounded-full px-4 py-1 bg-sky-500 text-white">Buy</button>
                </div>
            </div>
            <div class="bg-white h-full rounded-2xl drop-shadow-lg">
                <p class="px-6 pt-6 font-normal text-2xl">MacBook Air</p>
